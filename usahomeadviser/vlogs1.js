...
var articlesData = [
    {
        ...
        duration: "12:45",
        content: "In today's digital age, protecting your home has never been more important. Smart home security systems offer advanced features that go beyond traditional alarm systems.\n\nKey features to consider:\n- 24/7 Professional monitoring\n- Mobile app control and notifications\n- Video surveillance with cloud storage\n- Smart home integration\n- Motion detection and smart alerts"
    },
    {
        id: 2,
    ...
    },
    {
        ...
        duration: "10:15",
        content: "Regular home maintenance prevents costly repairs and keeps your property in top condition year-round.\n\nSpring Tasks:\n- Inspect roof and gutters\n- Service HVAC system\n- Check exterior paint and siding\n\nSummer Tasks:\n- Inspect and clean deck/patio\n- Check irrigation system\n\nFall Tasks:\n- Clean gutters and downspouts\n- Winterize outdoor faucets\n\nWinter Tasks:\n- Monitor for ice dams\n- Check insulation\n- Test smoke and CO detectors"
    },
    {
        id: 5,
    ...
    },
    {
        ...
        image: "https://i.ytimg.com/vi/EaV74R2rMwk/hqdefault.jpg",
        duration: "17:10",
        content: "With remote work becoming more common, a well-designed home office is essential for productivity.\n\nEssential Elements:\n- Ergonomic desk and chair\n- Proper lighting\n- Organized storage solutions\n- Technology setup\n- Soundproofing or noise reduction"
    },
    {
        id: 16,
...
var blogPageUrls = {
    // UPDATE: replace each URL with your actual WordPress page URL on usahomeadviser.com
    // Local HTML files are shown as comments for reference
    1:  'https://usahomeadviser.com/security-cameras/',        // local: blog-security-cameras.html
    2:  'https://usahomeadviser.com/complete-guide-to-kitchen-remodeling/',      // local: blog-kitchen-remodeling.html
    3:  'https://usahomeadviser.com/solar-panel-installation/',                  // local: blog-solar-panel.html
    4:  'https://usahomeadviser.com/diy-home-maintenance-checklist/',            // local: blog-home-maintenance.html
    5:  'https://usahomeadviser.com/beautiful-bathroom-vanity/',                 // local: blog-bathroom-vanity.html
    6:  'https://usahomeadviser.com/beautiful-before-and-after-kitchen-remodel/', // local: blog-kitchen-storage.html
    7:  'https://usahomeadviser.com/my-ahs-story-ramon-and-alex/',               // local: blog-ahs-story.html
    8:  'https://usahomeadviser.com/remodel-regrets-avoid-these-design-mistakes/', // local: blog-remodel-regrets.html
    9:  'https://usahomeadviser.com/smart-lighting-systems-buyer-guide/',         // local: blog-smart-lighting.html
    10: 'https://usahomeadviser.com/basement-finishing-ideas-on-a-budget/',       // local: blog-basement-finishing.html
    11: 'https://usahomeadviser.com/outdoor-security-camera-installation-tips/',  // local: blog-outdoor-security.html
    12: 'https://usahomeadviser.com/hvac-maintenance-keep-your-system-running/',  // local: blog-hvac-maintenance.html
    13: 'https://usahomeadviser.com/smart-thermostat-installation-guide/',        // local: blog-smart-thermostat.html
    14: 'https://usahomeadviser.com/garage-door-repair-and-maintenance/'          // local: blog-garage-door.html
};
...
function loadArticles() {
    ...
    for (var i = 0; i < articlesToShow.length; i++) {
        var articleCard = createArticleCard(articlesToShow[i]);
...
function handleNewsletterSubmit(e) {
    ...
    if (email) {
        setTimeout(function() {
            showToast('Successfully subscribed! Welcome to USA Home Adviser.', 'success');
            emailInput.value = '';
        }, 500);
    }
}
